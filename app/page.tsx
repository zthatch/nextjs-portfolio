    ...
    <section>
      <div className="flex justify-between">
        <Image
          ...
          src={avatar}
          className="border border-neutral-200 dark:border-neutral-700 rounded-full h-20 w-20 float-left"
        />
        <p className="font-bold prose prose-neutral dark:prose-invert mr-20">
      ...
      <h2 className="mt-3 text-2xl font-bold tracking-tighter">
        ...
        <p className="ml-8 prose prose-neutral dark:prose-invert">
          ...
          <ul className="ml-12 list-disc text-gray-800">
